...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'simple/nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file=data_root + 'simple/nuscenes_infos_temporal_val.pkl',
...
evaluation = dict(interval=1, pipeline=test_pipeline, metric='chamfer', save_best='NuscMap_chamfer/mAP', rule='greater')
...
# resume_from = './work_dirs/gmap_dattn_fgeoloss_tiny_r50_110e_wdecay0.03/epoch_35.pth'
# resume = True
